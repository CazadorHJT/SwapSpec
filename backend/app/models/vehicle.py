...
class Vehicle(Base):
    ...
    drive_type: Mapped[str] = mapped_column(String(50), nullable=True)
    body_style: Mapped[str] = mapped_column(String(100), nullable=True)
    doors: Mapped[int] = mapped_column(Integer, nullable=True)
    engine_displacement_l: Mapped[float] = mapped_column(Float, nullable=True)
    engine_cylinders: Mapped[int] = mapped_column(Integer, nullable=True)
